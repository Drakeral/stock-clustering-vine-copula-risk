...
class RunManifestTests(unittest.TestCase):
    ...
    def test_default_outputs_cover_panels_and_separate_gate_audits(self):
        ...
        self.assertIn("data/audit/ml_clustering_diagnostics.json", paths)
        self.assertIn("data/audit/ml_marginal_model_quality.json", paths)
        self.assertIn("data/audit/ml_gaussian_copula_quality.json", paths)
        self.assertIn("data/audit/ml_vine_copula_quality.json", paths)
        self.assertIn("data/audit/ml_model_evaluation.json", paths)
        ...
        self.assertIn("data/processed/ml_annual_group_assignments.json", paths)
        self.assertIn("data/processed/ml_annual_group_returns.parquet", paths)
        self.assertIn("data/processed/ml_marginal_refits.parquet", paths)
        self.assertIn("data/processed/ml_marginal_daily_forecasts.parquet", paths)
        self.assertIn("data/processed/ml_monthly_copula_training_pits.parquet", paths)
        self.assertIn("data/processed/ml_gaussian_copula_refits.parquet", paths)
        self.assertIn("data/processed/ml_gaussian_risk_forecasts.parquet", paths)
        self.assertIn("data/processed/ml_vine_copula_refits.parquet", paths)
        self.assertIn("data/processed/ml_vine_risk_forecasts.parquet", paths)
        self.assertIn("data/processed/ml_risk_evaluation_daily.parquet", paths)
        self.assertIn("data/processed/historical_simulation_risk_forecasts.parquet", paths)
        self.assertIn("data/processed/historical_simulation_windows.parquet", paths)
        self.assertIn(
            "data/processed/current_composition_hs_robustness/daily_scores.parquet", paths
        )
        ...
        self.assertIn("data/processed/vine_copula_refits.parquet", paths)
        self.assertIn("data/processed/vine_risk_forecasts.parquet", paths)
